...
class ExampleStartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: <Widget>[
        ...
        InkWell(
          child: _getChatEntry(logo: FlutterLogo()),
          onTap: () {print('Test');},
        )
        ,
        _getChatEntry(
  ...
  Widget _getChatEntry({String blogTitle = defaultBlogTitle, String postHeading = defaultPostHeading, required Widget logo, String date = 'Just now'}) {
    if (logo == null) {
      logo = defaultImage;
    }
